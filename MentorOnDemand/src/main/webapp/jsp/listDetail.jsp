...
<div>
<button class="buttonCompany buttonCom" style="margin-left:700px;margin-bottom:200px"><a href="/listUser">User</a></button>
<button class="buttonCompany buttonCom"><a href="/listMentor">Mentor</a></button>
