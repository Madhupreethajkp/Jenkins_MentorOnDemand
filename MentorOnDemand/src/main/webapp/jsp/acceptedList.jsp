...
<button class="button1" type="submit" ><span><a href="/listDetail" style="text-decoration:none; color:white">List Users/Mentors</span></button>
...
<div class="container" style="color:black">
    ...
    <th>Reject</th>
               ...
               <%
                  List techList=(List)request.getAttribute("acceptedList");
  ...
  <td><%= t.getId() %>
   ...
   <td><%= t.getMentor_id() %>
   <td><%= t.getStatus() %>
    <td><a href="confirmAccept?training_id=<%= t.getTraining_id() %>" class="btn btn-info btn-lg">Confirm Accept</a></td>
      <td><a href="confirmReject?training_id=<%= t.getTraining_id() %>" class="btn btn-info btn-lg">Confirm Reject</a></td>
